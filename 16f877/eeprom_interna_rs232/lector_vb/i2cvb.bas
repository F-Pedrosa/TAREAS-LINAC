...
'
' These functions are compatible with the 16 bit DLL  WINio.DLL . code porting should give no problems
' This is a Beta release of Version 1.0  Version 1.1 will include 32 bit read and writes
'
...
Dim a As Long
' Notice about this routine. It inserts a delay loop, because VB lacks the feature of a microtimer.
' There are cleaner approches to do this but this works just fine.
' the parameter of 1000 is fine on a 486 DX2-66, 200 in a Pentium 100 (FeP)

For a = 0 To (count * 200)  ' adapt this value according to the speed of the CPU
Next a
...
'       Dim internalloop As Integer
   ...
   'Dim i2ca As Integer, i2cb As Integer
       i2cresult% = 0
...
'          End If
'End If
'If I2Ctest.Text5 <> "" Then
'    I2Ctest.Text5 = I2Ctest.Text5 & LF & dta$
'Else
'    I2Ctest.Text5 = dta$
'End If

'If mensajes_de_debug <> "" Then
'    mensajes_de_debug = mensajes_de_debug & LF & dta$
'Else
'    mensajes_de_debug = dta$
'End If
