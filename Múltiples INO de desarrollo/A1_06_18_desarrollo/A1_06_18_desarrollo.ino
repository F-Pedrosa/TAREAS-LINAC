...
const int intervalo = 15;                    // 5 minutos, valor aleatorio elegido sin mayor implicancia
...
void grabar_datos_archivo()
{
  ...
  file.print((float)temperature); //file.print(F(" *C, "));
  file.print(F(" - "));
  file.print((float)humidity); //file.print(F(" RH%"));
  file.print(F(" -               "));
