...
const int intervalo = 7;                    // 5 minutos, valor aleatorio elegido sin mayor implicancia
unsigned long currentMillis = 0;
unsigned long previousMillis = 0;
const unsigned long interval = 10000;                       // 30 segundos es el tiempo que le asignamos para esperar el pedido desde el cel.
