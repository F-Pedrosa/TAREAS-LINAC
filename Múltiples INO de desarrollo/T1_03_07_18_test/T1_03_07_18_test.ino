...
void wakeUp(){contador = contador + 1; zumbar = true;}
// ------------------------------------------------------------------------------------------------------------------
...
//    // esperar pedido de conexión desde el celular durante "intervalo" segundos.
