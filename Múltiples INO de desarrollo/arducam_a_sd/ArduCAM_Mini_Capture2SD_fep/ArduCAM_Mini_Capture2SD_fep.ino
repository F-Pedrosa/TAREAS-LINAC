...
delay(10000);             // 10 seg de espera para darme tiempo a conectar, medir y demases
digitalWrite(LED_BUILTIN, HIGH);  //encender led amarillo
}

// este es el lazo principal, equivalente al FOREVER LOOP de JAL
void loop(){
if (indice = 20)
{
digitalWrite(LED_BUILTIN, LOW);  //apagar led amarillo  
}
else
{
//digitalWrite(LED_BUILTIN, HIGH);  //encender led amarillo
