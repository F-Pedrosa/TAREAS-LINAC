...
void loop() {
    if (newData == false){
        ...
        // BLOQUE INICIAL, QUE LEE EL TAMAÑO DEL ARCHIVO Y REPORTA EL TIEMPO AL MIT
        ...
        if (primera_vez){                    
          ...
          // BLOQUE DE ENVÍO DEL ARCHIVO PROPIAMENTE DICHO
          ...
          if (segundo_paquete){
            ...
            // LAS SIGUIENTE LÍNEAS DEBERÍAN CERRAR LA CONEXIÓN ASÍ EL MIT GRABA LOS DATOS RECIBIDOS.
            file.close();
            Serial.println("");
            wait_for_esp_response(1100);          
            Serial.println(F("AT+CIPCLOSE=0"));
