/* 
 ...
 Uso de Pines (el nÃºmero corresponde al modo de numeraciÃ³n de Arduino, que estÃ¡ impreso en el sikscreen):
 0 Rx Interfaz Serie
 1 Tx Interfaz Serie
 2 Entrada pulsador 1 (bornera verde mÃ¡s al borde)
 3 Entrada contador de pulsos (siguiente bornera verde)
 4 Entrada digital que puede contar (bornera verde mÃ¡s interna)
 5 Control alimentaciÃ³n Nordic
 6 Control entrada alim 2
 7 Control entrada alim 1
 8 Control SelecciÃ³n Arducam
 9 Control zumbador y led testigo
 10 Control SelecciÃ³n SD1
 11 BUS SPI
 12 BUS SPI
 13 BUS SPI
 A0 Control sensor de Humedad
 A1 Control SelecciÃ³n SD2 / Control Nordic
 A2 Control led testigo 2 / Control Nordic
 A4 BUS I2C
 A5 BUS I2C
 A6 entrada analÃ³gica mediciÃ³n alimentaciÃ³n
 A7 Entrada AnalÃ³gica Selector

 Nota: BUS SPI es usado por el ArduCam, la(s) SD(s) y el Nordic. BUS I2C es usado por el RTC, el sensor de presiÃ³n y el ArduCam
...
// Lista de pins que se controlarÃ¡n
Pin monitored_pins[] = {
  {2,  "D2"},
  {3,  "D3"},
};
...
// direcciÃ³n en el bus I2C del RTC
...
// Procedimiento que espera la llegada de un caracter por le vÃ­a USB-TTL y reacciona en consecuencia
