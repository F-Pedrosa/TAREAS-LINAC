...
const int intervalo = 260;                    // 5 minutos, valor aleatorio elegido sin mayor implicancia
unsigned long currentMillis = 0;
unsigned long previousMillis = 0;
const unsigned long interval = 40000;                       // 30 segundos es el tiempo que le asignamos para esperar el pedido desde el cel.
