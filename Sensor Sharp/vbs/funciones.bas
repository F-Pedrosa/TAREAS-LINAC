...
Public Direccion_I2C As Byte

Public tamanio_eeprom(8) As Long
Public eeproms(8) As Byte

Public cual_eeprom As Integer

Public mensaje_debug As String
...
If mi_var0 = mi_var1 Then
    ...
    ' Leer nuevamente la supuesta última dirección + 1
...
End Function
Public Function codificar_bcd(valor As Byte) As Byte
Dim loc As Byte
